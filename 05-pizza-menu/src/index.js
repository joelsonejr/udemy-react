...
const Footer = () => {
  ...
  return (
    <footer className="footer">
      {new Date().toLocaleTimeString()}. We're currentely open!
    </footer>
  );
  // return React.createElement("footer", null, "We're currentely open!");
};
...
//React.render(<App />, document.getElementById("root")); -- React before v18
